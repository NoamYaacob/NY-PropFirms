...
const EVALUATION: AccordionItem[] = [
  ...
  },
  {
    ...
    content: "לא. המבחן הוא תשלום חד-פעמי ל-30 ימים קלנדריים. אין חידוש אוטומטי, אין מנוי ואין אפשרות לאיפוס. אחרי מעבר, יש 7 ימים קלנדריים להפעלת חשבון ה-PA.",
  },
  {
    id: "e2",
...
const PA: AccordionItem[] = [
  ...
  {
    id: "p7",
    trigger: "מה קורה אם לא סחרתי ב-PA לתקופה ממושכת?",
    content: "כדי לשמור על חשבון PA פעיל, צריך להשלים 2 ימי מסחר עם רווח נטו של $50 ומעלה בכל חלון מתגלגל של 30 יום. אם התנאי לא מתקיים, החשבון עלול להיסגר בגלל חוסר פעילות.",
  },
];
