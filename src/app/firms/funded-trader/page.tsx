...
export const metadata: Metadata = { title: "Funded Trader — בקרוב | NY Prop Firms" };

export default function FundedTraderPage() {
  return (
    <div className="container-page py-20 text-center">
      <h1 className="text-3xl font-bold mb-4" style={{ color: "var(--text-primary)" }}>Funded Trader</h1>
